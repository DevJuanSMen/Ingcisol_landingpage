    ...
    <footer className="border-t border-white/10 bg-ink px-6 py-12">
      <div className="mx-auto max-w-6xl">
        <div className="flex flex-col gap-8 md:flex-row md:items-start md:justify-between">
          ...
          <ul className="flex flex-wrap gap-x-6 gap-y-2 text-sm text-silver/70">
            {navLinks.map((link) => (
              <li key={link.href}>
                <a href={link.href} className="hover:text-silver">
                  {link.label}
                </a>
              </li>
            ))}
            <li>
              <a href="#faq" className="hover:text-silver">
                FAQ
              </a>
            </li>
          </ul>

          <div className="text-sm text-silver/60 space-y-2">
            <a
              href={INSTAGRAM_URL}
              target="_blank"
              rel="noopener noreferrer"
        ...
        <div className="mt-10 border-t border-white/10 pt-6 text-xs text-silver/50">
          <p>
            INGCISOL Ingeniería y Construcción S.A.S. · NIT 901.756.227-8 · Valledupar,
            Cesar, Colombia.
          </p>
          <p className="mt-1">© 2026 INGCISOL Ingeniería y Construcción S.A.S.</p>
        </div>
      </div>
    </footer>
  );
